...
# compute delta table values and fit polynomial
values = {}
for s0 in range(3):
    for w0 in range(3):
...
print('fitted polynomial coefficients for actual delta:', poly)
print('formula-produced poly:', _evaluate_delta_e(p,q,r,s,t))
