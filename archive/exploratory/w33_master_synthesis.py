...
class W33MasterSynthesis:
    ...
    def derive_standard_model(self):
        ...
        print(f"  Alternative: 1/(22×2π) = {alpha_w33_alt:.6f}, Error: {error_alt:.1f}%")
        print()
        
        results["alpha"] = {"predicted": alpha_w33, "observed": alpha_obs, "error": error_alpha}
        ...
        results["alpha_s"] = {"predicted": alpha_s_w33, "observed": alpha_s_obs, "error": error_s}
        ...
        results["theta_12"] = {"predicted": theta_12_w33, "observed": theta_12_obs, "error": error_12}
        ...
        results["delta_cp"] = {"predicted": delta_w33, "observed": delta_obs, "error": error_delta}
        ...
        results["m_higgs"] = {"predicted": m_h_w33_2, "observed": m_h_obs, "error": error_mh}
        ...
        results["omega_lambda"] = {"predicted": omega_lambda_w33, "observed": omega_lambda_obs, "error": error_omega}
        ...
        print()
        print(f"Success rate: {good_predictions}/{len(results)} = {100*good_predictions/len(results):.0f}%")
        print()
