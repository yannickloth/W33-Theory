...
_sage_const_60 = Integer(60); _sage_const_6 = Integer(6); _sage_const_3 = Integer(3); _sage_const_9 = Integer(9); _sage_const_5 = Integer(5); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_40 = Integer(40)# W(5,3) and Klein Correspondence Verification
...
for v in V5:
    if not v.is_zero():
        if v[_sage_const_0 ]**_sage_const_2  + v[_sage_const_1 ]*v[_sage_const_2 ] + v[_sage_const_3 ]*v[_sage_const_4 ] == _sage_const_0 :
            count += _sage_const_1 
...
print(f"Formula: (3^6-1)/(3-1) = {(_sage_const_3 **_sage_const_6 -_sage_const_1 )//(_sage_const_3 -_sage_const_1 )}")
...
print(f"Formula: (3^3+1)(3^3-1)/(3-1) = {(_sage_const_3 **_sage_const_3 +_sage_const_1 )*(_sage_const_3 **_sage_const_3 -_sage_const_1 )//(_sage_const_3 -_sage_const_1 )}")
...
print(f"PSp(4, 3) = Sp(4,3)/Z = order {Sp(_sage_const_4 ,_sage_const_3 ).order()//_sage_const_2 }")
