...
def physics_predictions():
    ...
    alpha_error = abs(alpha_inv_predicted - alpha_inv_measured) / alpha_inv_measured * 100
...
def main():
    ...
    print(f"E7: dim={eseries['e7']['dimension']}, fund={eseries['e7']['fundamental_rep']}")
    ...
    print("-" * 70)
    gut = gut_connection()
    print(f"Gauge Structure: {gut['gauge_structure']['w33_k4s']} K4s = {gut['gauge_structure']['relation']}")
    ...
    print(f"j-function: {moon['j_function']['coefficient']} = {moon['j_function']['decomposition']}")
