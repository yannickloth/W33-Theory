...
bij = sys.argv[1]
seeds = [int(s) for s in sys.argv[2:]] if len(sys.argv) > 2 else [212,213,214,215,216]
...
for seed in seeds:
    ...
    if cpsat.exists():
        dest = Path('checks') / f'dd_repro_pair_1770577580_{bij_label}_seed{seed}_{stamp}_cpsat.json'
