...
inpath = (
    ...
    / "PART_CVII_e8_bijection_campaign_result_1770513416.json"
)
...
for tri in triangles:
    ...
    r_ac = roots[r_ac_idx]
    sums = [
        tuple(vec_add(r_ab, r_bc)),
        tuple(vec_sub(r_ab, r_bc)),
        tuple(vec_add(r_ab, vec_neg(r_bc))),
        tuple(vec_sub(vec_neg(r_ab), r_bc)),
    ]
        ...
        failed_tris.append(
            {
                ...
                "roots": [r_ab_idx, r_bc_idx, r_ac_idx],
            }
        )
