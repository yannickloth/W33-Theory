...
print('Neighbors of vertex', edges[37][0], ':', [i for i in range(n) if adj[edges[37][0]][i]])
print('Neighbors of vertex', edges[37][1], ':', [i for i in range(n) if adj[edges[37][1]][i]])
print('Neighbors of vertex', edges[38][0], ':', [i for i in range(n) if adj[edges[38][0]][i]])
print('Neighbors of vertex', edges[38][1], ':', [i for i in range(n) if adj[edges[38][1]][i]])
