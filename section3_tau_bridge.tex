...
Let $E\colon y^2=x^3-35x+98$ (\,$j=-3375=-g^3$, conductor $49$\,).
This curve has CM by $\mathbb{Z}[(1+\sqrt{-7})/2]$; for inert primes
$\left(\frac{-7}{p}\right)=-1$ one has $a_p(E)=0$, and
\[
...
The CM property (quadratic twist of $y^2=x^3-35x-98$ by $d=-1$)
...
and $g/3=\Phi_4/2=5$). This identity $g/3=\Phi_4/2$ is a cross-sector link:
...
Let $P=q(\Phi_4/2)(\Phi_4+\Phi_6)=3\cdot 5\cdot 17=255$. The complete $j$-tower is:
