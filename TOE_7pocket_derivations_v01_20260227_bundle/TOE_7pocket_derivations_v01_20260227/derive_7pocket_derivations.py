...
Usage:
  python derive_7pocket_derivations.py \
...
def main():
    ...
    # Build oriented block orientation from canonical edge in each edgepair on each W33 line.
    block_oriented = {}
    for line in w33_line_map:
        ...
        for m in matchings:
            ...
            block = frozenset(verts)
            block_oriented[block] = verts
