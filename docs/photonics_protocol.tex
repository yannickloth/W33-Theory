...
\item
  \textbf{Discrete Pancharatnam phase} via Berry‑phase loops on explicit
  Witting‑ray triangles (quantized at
...
\subsection{\texorpdfstring{5. Pancharatnam Phase Test
(\ensuremath{\pi}/6,
\ensuremath{\pi}/2)}{5. Pancharatnam Phase Test (/6, /2)}}\label{pancharatnam-phase-test-6-2}

\textbf{Signature:} phases clustered at
\textbf{\ensuremath{\pm}\ensuremath{\pi}/6} and
\textbf{\ensuremath{\pm}\ensuremath{\pi}/2}.
...
\item
  ...
  score.
\item
  Measure triangle phases for the \ensuremath{\pi}/6, \ensuremath{\pi}/2
  signature.
\end{itemize}
...
\item
  Pancharatnam phase quantization: \textbf{Φ \ensuremath{\in}
