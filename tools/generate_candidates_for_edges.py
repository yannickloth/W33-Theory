...
OUT_JSON = Path(
    "analysis/minimal_commutator_cycles/w33_uv_parser_det1_problem_edges_top20_candidates.json"
)
OUT_CSV = Path(
    "analysis/minimal_commutator_cycles/w33_uv_parser_det1_problem_edges_top20_candidates.csv"
)
...
with OUT_CSV.open("w", encoding="utf-8", newline="") as f:
    f.write(
        "edge_a,edge_b,count,num_direct_candidates,top_candidate_vector,top_candidate_score,top_candidate_confidence\n"
    )
    for ent in report["edges"]:
        ...
        f.write(
            f"{a},{b},{ent['count']},{ent['num_direct_candidates']},{top_vec},{top_score},{top_conf}\n"
        )
