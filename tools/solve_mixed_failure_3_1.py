#!/usr/bin/env python3
"""Same as tools/solve_mixed_failure.py but targets the triple (0,0),(17,1),(3,1).
Writes artifacts/mixed_triple_lsq_correction_3_1.json
"""
...
OUT = ROOT / "artifacts" / "mixed_triple_lsq_correction_3_1.json"
...
if __name__ == "__main__":
    ...
    # also compute 'delta' for uniform->uniform+delta
    ...
    out = {
        ...
        "lsq_solution_float": [float(v) for v in sol],
