...
def main():
    ...
    for idx in range(len(sol)):
        ...
        cmd = ['py', '-3', 'tools/extract_e8_rootword_cocycle.py', '--cycles-json', str(CYCLES_JSON), '--a2-index', str(idx), '--out-dir', str(outdir)]
        ...
        stats = j.get('stats', {})
        summary.append({'a2_index': idx, 'a2_indices': j.get('a2_indices'), 'ai_idx': j.get('ai_idx'), 'bi_idx': j.get('bi_idx'), 'stats': stats})
