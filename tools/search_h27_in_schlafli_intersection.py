#!/usr/bin/env python3
"""Search for an embedding of H27 into the Schläfli intersection graph.

Find a permutation p of 27 vertices such that every H27 edge maps to an
intersection edge (lines that meet). This checks whether H27 is a spanning
8-regular subgraph of the Schläfli intersection graph.
"""
...
def main():
    ...
    s_adj = schlafli_intersection_graph()

    print("Searching for H27 embedding in Schläfli intersection graph...")
    ...
    out_path = ROOT / "artifacts" / "h27_in_schlafli_intersection.json"
