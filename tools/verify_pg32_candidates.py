#!/usr/bin/env python3
"""Verify CP‑SAT candidates produced by `tools/seed_hybrid_from_pg32.py`.
...
RES_FILE = ROOT / "artifacts" / "pg32_seeded_hybrid_results.json"
if not RES_FILE.exists():
    raise SystemExit("No pg32_seeded_hybrid_results.json artifact found")
