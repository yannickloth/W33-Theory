...
for i in range(4):
    ...
    stats['match_rate_divisible'] = (k_match_divisible / divisible_with_k) if divisible_with_k else None
    summary.append({'a2_index': i, 'ai_idx': j.get('ai_idx'), 'bi_idx': j.get('bi_idx'), 'stats': dict(stats)})
