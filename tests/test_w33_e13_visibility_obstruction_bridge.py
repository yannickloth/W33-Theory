...
def test_e13_visibility_obstruction_bridge_summary() -> None:
    ...
    assert theorem["current_external_bridge_does_not_pick_a_canonical_line_for_the_e13_image"] is True
    assert theorem["current_external_bridge_matches_only_the_graded_shadow_of_the_transport_channel"] is True
    assert theorem["current_bridge_captures_only_carrier_plane_and_graded_shadow_of_the_central_channel"] is True
