...
def test_predict_dual_anchor_010_target16_line_families() -> None:
    samples = [
        (((20, 0), (7, 0), (26, 1)), [], [], [(26, 16, "1/54")]),
        (((20, 0), (7, 0), (26, 2)), [], [], [(26, 16, "1/54")]),
        (((20, 0), (7, 1), (26, 0)), [], [(7, 16, "1/54")], []),
        (((20, 0), (7, 2), (26, 0)), [], [(7, 16, "1/54")], []),
        (((20, 0), (11, 0), (25, 1)), [], [], [(25, 16, "-1/54")]),
        (((20, 0), (11, 0), (25, 2)), [], [], [(25, 16, "-1/54")]),
        (((20, 0), (11, 1), (25, 0)), [], [(11, 16, "-1/54")], []),
        (((20, 0), (11, 2), (25, 0)), [], [(11, 16, "-1/54")], []),
        (((20, 0), (13, 0), (24, 1)), [], [], [(24, 16, "-1/54")]),
        (((20, 0), (13, 0), (24, 2)), [], [], [(24, 16, "-1/54")]),
        (((20, 0), (13, 1), (24, 0)), [], [(13, 16, "-1/54")], []),
        (((20, 0), (13, 2), (24, 0)), [], [(13, 16, "-1/54")], []),
        (((20, 0), (15, 0), (22, 1)), [], [], [(22, 16, "1/54")]),
        (((20, 0), (15, 0), (22, 2)), [], [], [(22, 16, "1/54")]),
        (((20, 0), (15, 1), (22, 0)), [], [(15, 16, "1/54")], []),
        (((20, 0), (15, 2), (22, 0)), [], [(15, 16, "1/54")], []),
    ]
    for triple, expected_u, expected_v, expected_w in samples:
        uvw = predict_dual_g1g2g2_uvw(*triple)
        assert uvw is not None, triple
...
def test_predict_dual_anchor_010_overlap_families() -> None:
    samples = [
        (((20, 0), (7, 1), (19, 0)), [(12, 2, "-1/108")], [(7, 6, "-1/108")]),
        (((20, 0), (7, 2), (19, 0)), [(12, 1, "1/108")], [(7, 6, "-1/108")]),
        (((20, 0), (9, 1), (25, 0)), [(4, 2, "1/108")], [(9, 14, "1/108")]),
        (((20, 0), (9, 2), (25, 0)), [(4, 1, "-1/108")], [(9, 14, "1/108")]),
        (((20, 0), (11, 1), (17, 0)), [(14, 2, "1/108")], [(11, 4, "1/108")]),
        (((20, 0), (11, 2), (17, 0)), [(14, 1, "-1/108")], [(11, 4, "1/108")]),
        (((20, 0), (13, 1), (18, 0)), [(8, 2, "1/108")], [(13, 10, "-1/108")]),
        (((20, 0), (13, 2), (18, 0)), [(8, 1, "-1/108")], [(13, 10, "-1/108")]),
        (((20, 0), (21, 1), (22, 0)), [(0, 2, "1/108")], [(21, 23, "1/108")]),
        (((20, 0), (21, 2), (22, 0)), [(0, 1, "-1/108")], [(21, 23, "1/108")]),
    ]
    for triple, expected_u, expected_v in samples:
        uvw = predict_dual_g1g2g2_uvw(*triple)
        assert uvw is not None, triple
...
def test_predict_dual_anchor_001_line_families() -> None:
    samples = [
        (((21, 0), (2, 0), (15, 1)), [], [], [(15, 0, "1/54")]),
        (((21, 0), (2, 0), (15, 2)), [], [], [(15, 0, "1/54")]),
        (((21, 0), (2, 1), (15, 0)), [], [(2, 0, "1/54")], []),
        (((21, 0), (2, 2), (15, 0)), [], [(2, 0, "1/54")], []),
        (((21, 0), (3, 0), (14, 1)), [], [], [(14, 0, "-1/54")]),
        (((21, 0), (3, 0), (14, 2)), [], [], [(14, 0, "-1/54")]),
        (((21, 0), (3, 1), (14, 0)), [], [(3, 0, "-1/54")], []),
        (((21, 0), (3, 2), (14, 0)), [], [(3, 0, "-1/54")], []),
        (((21, 0), (5, 0), (12, 1)), [], [], [(12, 0, "-1/54")]),
        (((21, 0), (5, 0), (12, 2)), [], [], [(12, 0, "-1/54")]),
        (((21, 0), (5, 1), (12, 0)), [], [(5, 0, "-1/54")], []),
        (((21, 0), (5, 2), (12, 0)), [], [(5, 0, "-1/54")], []),
        (((21, 0), (8, 0), (9, 1)), [], [], [(9, 0, "1/54")]),
        (((21, 0), (8, 0), (9, 2)), [], [], [(9, 0, "1/54")]),
        (((21, 0), (8, 1), (9, 0)), [], [(8, 0, "1/54")], []),
        (((21, 0), (8, 2), (9, 0)), [], [(8, 0, "1/54")], []),
        (((21, 0), (17, 0), (26, 1)), [], [], [(26, 22, "1/54")]),
        (((21, 0), (17, 0), (26, 2)), [], [], [(26, 22, "1/54")]),
        (((21, 0), (17, 1), (26, 0)), [], [(17, 22, "1/54")], []),
        (((21, 0), (17, 2), (26, 0)), [], [(17, 22, "1/54")], []),
        (((21, 0), (18, 0), (25, 1)), [], [], [(25, 22, "-1/54")]),
        (((21, 0), (18, 0), (25, 2)), [], [], [(25, 22, "-1/54")]),
        (((21, 0), (18, 1), (25, 0)), [], [(18, 22, "-1/54")], []),
        (((21, 0), (18, 2), (25, 0)), [], [(18, 22, "-1/54")], []),
        (((21, 0), (19, 0), (24, 1)), [], [], [(24, 22, "1/54")]),
        (((21, 0), (19, 0), (24, 2)), [], [], [(24, 22, "1/54")]),
        (((21, 0), (19, 1), (24, 0)), [], [(19, 22, "1/54")], []),
        (((21, 0), (19, 2), (24, 0)), [], [(19, 22, "1/54")], []),
        (((21, 0), (20, 0), (23, 1)), [], [], [(23, 22, "-1/54")]),
        (((21, 0), (20, 0), (23, 2)), [], [], [(23, 22, "-1/54")]),
        (((21, 0), (20, 1), (23, 0)), [], [(20, 22, "-1/54")], []),
        (((21, 0), (20, 2), (23, 0)), [], [(20, 22, "-1/54")], []),
    ]
    for triple, expected_u, expected_v, expected_w in samples:
        uvw = predict_dual_g1g2g2_uvw(*triple)
        assert uvw is not None, triple
...
def test_predict_dual_anchor_001_overlap_families() -> None:
    samples = [
        (((21, 0), (2, 1), (20, 0)), [(16, 2, "1/108")], [(2, 1, "1/108")]),
        (((21, 0), (2, 2), (20, 0)), [(16, 1, "-1/108")], [(2, 1, "1/108")]),
        (((21, 0), (3, 1), (26, 0)), [(6, 2, "1/108")], [(3, 11, "-1/108")]),
        (((21, 0), (3, 2), (26, 0)), [(6, 1, "-1/108")], [(3, 11, "-1/108")]),
        (((21, 0), (5, 1), (24, 0)), [(10, 2, "1/108")], [(5, 7, "1/108")]),
        (((21, 0), (5, 2), (24, 0)), [(10, 1, "-1/108")], [(5, 7, "1/108")]),
        (((21, 0), (8, 1), (18, 0)), [(13, 2, "1/108")], [(8, 4, "-1/108")]),
        (((21, 0), (8, 2), (18, 0)), [(13, 1, "-1/108")], [(8, 4, "-1/108")]),
        (((21, 0), (9, 1), (25, 0)), [(4, 2, "1/108")], [(9, 13, "-1/108")]),
        (((21, 0), (9, 2), (25, 0)), [(4, 1, "-1/108")], [(9, 13, "-1/108")]),
        (((21, 0), (12, 1), (19, 0)), [(7, 2, "-1/108")], [(12, 10, "-1/108")]),
        (((21, 0), (12, 2), (19, 0)), [(7, 1, "1/108")], [(12, 10, "-1/108")]),
        (((21, 0), (14, 1), (17, 0)), [(11, 2, "1/108")], [(14, 6, "-1/108")]),
        (((21, 0), (14, 2), (17, 0)), [(11, 1, "-1/108")], [(14, 6, "-1/108")]),
        (((21, 0), (15, 1), (23, 0)), [(1, 2, "-1/108")], [(15, 16, "-1/108")]),
        (((21, 0), (15, 2), (23, 0)), [(1, 1, "1/108")], [(15, 16, "-1/108")]),
    ]
    for triple, expected_u, expected_v in samples:
        uvw = predict_dual_g1g2g2_uvw(*triple)
        assert uvw is not None, triple
