...
def test_offset_no_pairs_writes_empty(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(sys, 'argv', ['scripts/local_hotspot_feasibility.py', '--edges', '37', '38', '--k', str(K), '--offset', str(offset), '--time-limit', '1', '--log-dir', str(checks)])
    ...
    out_files = list(checks.glob('PART_CVII_local_hotspot_feasibility_37_38_offset*_limit*_*.json'))
