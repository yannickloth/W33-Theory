...
from w33_current_k3_mixed_plane_fiber_shift_failure_bridge import (  # noqa: E402
    build_current_k3_mixed_plane_fiber_shift_failure_summary,
)


def test_current_mixed_plane_fiber_shift_state_is_zero() -> None:
    summary = build_current_k3_mixed_plane_fiber_shift_failure_summary()
    current = summary["current_mixed_plane_fiber_shift_state"]
    ...
    assert current["current_fiber_shift_matrix"] == [[0, 0], [0, 0]]


def test_current_mixed_plane_fiber_shift_failure_theorem_holds() -> None:
