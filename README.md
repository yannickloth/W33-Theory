...
- **Monster/Landauer closure:** the rigorous Monster bridge is the local `3B` shell `3^(1+12)`, now factoring exactly as `3^13 = 3^6 * 3^4 * 3^3`; its exact complement is the `3`-part of the sporadic factor in `C_M(3B)=3^(1+12).2Suz`, namely `|2Suz|_3 = 3^7`. The same `3^7` is also the lifted Lagrangian/max-abelian order inside `3^(1+12)`, and its `729` quotient factor is the exact selector completion `728 + 1` with `728 = dim sl(27)` and `1` the unique selector line. So the full Monster ternary part closes as `3^20 = 3^13 * 3^7 = 3^(Phi_3 + Phi_6)`, with the local complement taking the exact forms `3^7 = 3^4 * 3^3 = 3 * 3^6 = 3 * (728 + 1)`. This gives exact ternary costs `20 ln 3`, `13 ln 3`, `7 ln 3` and matches the promoted `3/13`, `4/13`, `7/13`, `39` package
