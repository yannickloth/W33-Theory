...
- Follow the exact route `Three-Channel Calculus -> Standard-Model Cyclotomic Rosetta -> One-Generator Closure -> Adjacency-to-Dirac Closure -> Spectral-Action Cyclotomic / q=3 Selection -> EH / q=3 Gravity Locks -> Curved Mode Projectors -> Curved Mode Residues -> Continuum Extractor -> Exceptional Channel Continuum Bridge -> Exceptional Operator Projectors -> Exceptional Tensor-Rank Dictionary -> Exceptional Residue Dictionary -> Curved Weinberg Lock -> Curved Rosetta Reconstruction -> Curved Finite Spectral Reconstruction -> Curved Roundtrip Closure -> Three-Sample Master Closure -> Inverse Rosetta Bridge -> Refinement Bridge`.
