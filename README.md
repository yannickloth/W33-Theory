...
| Is the Vogel-universal cross-check reproducible? | `docs/VOGEL_UNIVERSAL_RESEARCH_2026_02_11.md`, `docs/VOGEL_RATIONAL_DIMENSION_THEOREM_2026_02_11.md`, `docs/VOGEL_RATIONAL_HIT_CROSSWALK_2026_02_11.md` | `tools/vogel_universal_snapshot.py`, `tools/vogel_rational_dimension_theorem.py`, `tools/vogel_rational_hit_crosswalk.py` | `tests/test_vogel_universal_snapshot_smoke.py`, `tests/test_vogel_rational_dimension_theorem_smoke.py`, `tests/test_vogel_rational_hit_crosswalk_smoke.py` | `artifacts/vogel_universal_snapshot_2026_02_11.json`, `artifacts/vogel_rational_dimension_theorem_2026_02_11.json`, `artifacts/vogel_rational_hit_crosswalk_2026_02_11.json` |
...
| `Vogel universal snapshot` | exceptional-line Vogel parameter checks + s12 dimension-family scan (`728`, `486`, `242`) + rational-hit catalog for non-degenerate exceptional-line roots + exact arithmetic closure + family crosswalk on finite hit set | `tools/vogel_universal_snapshot.py`, `tools/vogel_rational_cubic_search.py`, `tools/vogel_rational_cubic_sweep.py`, `tools/vogel_rational_hit_catalog.py`, `tools/vogel_rational_dimension_theorem.py`, `tools/vogel_rational_hit_crosswalk.py` | `tests/test_vogel_universal_snapshot_smoke.py`, `tests/test_vogel_rational_cubic_search_smoke.py`, `tests/test_vogel_rational_cubic_sweep_smoke.py`, `tests/test_vogel_rational_hit_catalog_smoke.py`, `tests/test_vogel_rational_dimension_theorem_smoke.py`, `tests/test_vogel_rational_hit_crosswalk_smoke.py` | `docs/VOGEL_UNIVERSAL_RESEARCH_2026_02_11.md`, `docs/VOGEL_EXTENDED_FINDINGS_2026_02_11.md`, `docs/VOGEL_RATIONAL_HIT_CATALOG_2026_02_11.md`, `docs/VOGEL_RATIONAL_DIMENSION_THEOREM_2026_02_11.md`, `docs/VOGEL_RATIONAL_HIT_CROSSWALK_2026_02_11.md`, `artifacts/vogel_universal_snapshot_2026_02_11.json`, `artifacts/vogel_rational_cubic_search_2026_02_11.json`, `artifacts/vogel_rational_sweep.json`, `artifacts/vogel_rational_sweep.md`, `artifacts/vogel_rational_hit_catalog_2026_02_11.json`, `artifacts/vogel_rational_dimension_theorem_2026_02_11.json`, `artifacts/vogel_rational_hit_crosswalk_2026_02_11.json` |
...
python -m pytest tests/test_vogel_universal_snapshot_smoke.py tests/test_vogel_rational_dimension_theorem_smoke.py tests/test_vogel_rational_hit_crosswalk_smoke.py -q
```
