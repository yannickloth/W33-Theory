...
- If you want the fermion/Yukawa side first, read the live site's `One-Input Fermion Closure`, `Skew Yukawa Packet`, and `Truncated 122 Shell` entries in that order.
