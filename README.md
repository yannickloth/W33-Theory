...
The sharpest promoted closure on `master` is now the **continuum tail operator
normal form** statement of `CCCLXXXVIII`: the promoted observable shell
...
avatar. So the remaining wall is existence of one unique nonzero tail-operator
gauge class from genuine external realization data.
