...
- If you want the algebra shell first, use the live site's `Plain-English Map` entry `27 -> 729 -> 728 -> 364 -> 40 + 324`, then read the promoted `s12 / Klein ambient shell`, `Harmonic cube / Klein quartic / Vogel shell`, `Klein / Clifford topological lift`, and `Triality ladder algebra` results.
